        ...
        <section className="footer-info-section">
            <div className="footer-info-content">
                ...
                <div className="footer-column">
                    ...
                    <p>We would like to thank Nathan L.T. Tsang and Wanjiang Jacob Zhang for their assistance with data collection, as well as Sidi Huang, Yingdan Lu, Yilang Peng, Cindy Shen, and Francis Lee for refining the coding scheme and performing manual coding and checking.</p>
                </div>
            </div>
        </section>
